<?php
class GenObj{
	private $conndet = array("host"=>"localhost", "db"=>"yfv", "charset"=>"utf8", "u"=>"root", "p"=>"");
	private $conn=NULL; 
	
	private $plist=array();
	
	function testObj(){
	  echo "This is a test of GenObj!";
	}
...
<?php
 /* $obj=new GenObj(); echo "</BR>Testing the Generic object";
  $link=$obj->connect();
	$data=array("name"=>"Yohan", "age"=>20);
	$obj->setPList($data);
	echo $obj->getData("name");
	echo $obj->getData("age");
	$obj->setData("name", "Pandigama");
	$obj->setData("age", 40);
	echo $obj->getData("name");
	echo $obj->getData("age");
